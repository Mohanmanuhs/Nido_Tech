      ...
      <div className="max-w-5xl mx-auto">
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="space-y-6">
            ...
            <div className="text-right pt-6 border-t border-gray-700 mt-6">
              <h2 className="text-2xl font-bold text-green-400">
                Total: ₹ {totalAmount.toFixed(2)}
              </h2>
              <button className="mt-4 bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-xl text-white font-semibold">
                Proceed to Checkout
              </button>
            </div>
          </div>
